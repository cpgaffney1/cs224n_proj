class Model(object):
    ...
    def create_feed_dict(self, encoder_inputs_batch, decoder_inputs_batch, labels_batch=None):
    ...
    def predict_on_batch(self, sess, encoder_inputs_batch, decoder_inputs_batch,
